...
/**
 * Handles the creation of table `folder_template_member`.
 */
class m180522_014552_create_folder_template_member_table extends Migration
{
    public $table_name = '{{%folder_template_member}}';
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        ...
        $this->addCommentOnTable($this->table_name, '个人模板文件夹信息表');
    }
