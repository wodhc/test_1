...
/**
 * Handles the creation of table `folder_material_team`.
 */
class m180522_014510_create_folder_material_team_table extends Migration
{
    public $table_name = '{{%folder_material_team}}';
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        ...
        $this->addCommentOnTable($this->table_name, '团队素材文件夹信息表');
    }
